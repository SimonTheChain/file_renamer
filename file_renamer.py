...
class FileRenamerApp(QtGui.QMainWindow, main_frame.Ui_FileRenamerWindow):
    ...
    def set_codec(self):
        if self.default_ma.isChecked():
            ...
            try:
                filename["codec"] = \
                    [x for x, y in app_lists.CODECS if x == self.codec_combo.currentText()][0]
                self.set_results()
    ...
    def set_speed(self):
        if self.default_ma.isChecked():
            ...
            try:
                filename["speed"] = \
                    [x for x, y in app_lists.SPEED if x == self.speed_combo.currentText()][0]
                self.set_results()
    ...
    def set_audio_language(self):
        if self.default_ma.isChecked():
            ...
            try:
                filename["audio_language"] = \
                    [x for x, y, z in app_lists.LANGUAGES if x == self.audio_language_combo.currentText()][0]
                self.set_results()
    ...
    def set_sub_language(self):
        if self.default_ma.isChecked():
            ...
            try:
                filename["sub_language"] = \
                    [x for x, y, z in app_lists.LANGUAGES if x == self.sub_language_combo.currentText()][0]
                self.set_results()
    ...
    def set_sub_notes(self):
        if self.default_ma.isChecked():
            ...
            try:
                filename["sub_notes"] = \
                    [x for x, y in app_lists.SUB_NOTES if x == self.sub_notes_combo.currentText()][0]
                self.set_results()
    ...
    def set_ratio(self):
        if self.default_ma.isChecked():
            ...
            try:
                filename["ratio"] = \
                    [x for x, y in app_lists.RATIOS if x == self.ratio_combo.currentText()][0]
                self.set_results()
