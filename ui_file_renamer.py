...
class Ui_FileRenamerWindow(object):
    def setupUi(self, FileRenamerWindow):
        ...
        FileRenamerWindow.resize(999, 712)
        ...
        FileRenamerWindow.setTabOrder(self.trailer_nb_line, self.trailer_pass_line)
        FileRenamerWindow.setTabOrder(self.trailer_pass_line, self.season_nb_line)
        FileRenamerWindow.setTabOrder(self.season_nb_line, self.episode_nb_line)
        ...
        FileRenamerWindow.setTabOrder(self.speed_combo, self.audio_language_combo)
        FileRenamerWindow.setTabOrder(self.audio_language_combo, self.sub_language_combo)
        FileRenamerWindow.setTabOrder(self.sub_language_combo, self.sub_notes_combo)
        FileRenamerWindow.setTabOrder(self.sub_notes_combo, self.extension_combo)
        FileRenamerWindow.setTabOrder(self.extension_combo, self.facility_combo)
