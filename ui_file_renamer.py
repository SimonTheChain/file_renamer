...
class Ui_FileRenamerWindow(object):
    def setupUi(self, FileRenamerWindow):
        ...
        FileRenamerWindow.resize(999, 747)
        ...
        self.platform_ma.setChecked(False)
        ...
        self.platform_mezz.setChecked(True)
    ...
    def retranslateUi(self, FileRenamerWindow):
        ...
        self.groupBox_2.setTitle(_translate("FileRenamerWindow", "Platform", None))
        self.platform_ma.setText(_translate("FileRenamerWindow", "MediAffinity", None))
        self.platform_mezz.setText(_translate("FileRenamerWindow", "Mezz", None))
        self.validate_btn.setText(_translate("FileRenamerWindow", "Validate", None))
        self.copy_btn.setText(_translate("FileRenamerWindow", "Copy", None))
        self.groupBox.setTitle(_translate("FileRenamerWindow", "Defaults", None))
