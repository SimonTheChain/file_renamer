...
class Ui_FileRenamerWindow(object):
    def setupUi(self, FileRenamerWindow):
        ...
        FileRenamerWindow.resize(999, 777)
        ...
        self.audio_config1 = QtGui.QComboBox(self.frame_4)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.audio_config1.setFont(font)
        self.audio_config1.setObjectName(_fromUtf8("audio_config1"))
        self.horizontalLayout_22.addWidget(self.audio_config1)
        ...
        self.audio_lyt = QtGui.QHBoxLayout()
        ...
        self.type_combo = QtGui.QComboBox(self.frame)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.type_combo.setFont(font)
        self.type_combo.setObjectName(_fromUtf8("type_combo"))
        self.horizontalLayout_9.addWidget(self.type_combo)
